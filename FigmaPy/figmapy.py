"""Synchronous FigmaPy API"""

import json

import requests

from FigmaPy.datatypes import Comment, File, FileMeta, Project  # noqa
from FigmaPy.datatypes.results import Comments, FileImages, FileVersions, TeamProjects


class FigmaPy:
    """Synchronous Figma Request class"""

    def __init__(self, token, oauth2=False):
        """Create a new instance of FigmaPy"""
    ...
    def get_file(
        ...
        Figma API Endpoint: https://www.figma.com/developers/api#get-files-endpoint
        """
        optional_data = ""
    ...
    def get_file_images(self, file_key, ids, scale=None, format=None, version=None):
        ...
        Figma API Endpoint: https://www.figma.com/developers/api#get-images-endpoint
        """
        optional_data = ""
        ...
        id_list = ",".join(id_array)
        data = self.api_request(
            "images/{0}?ids={1}{2}".format(file_key, id_list, optional_data),
            method="get",
        )
        if data is not None:
    ...
    def get_image_fills(self, file_key):
        """
        Get urls for source images from a file

        A fill is a user provided image

        Figma Docs: https://www.figma.com/developers/api#get-image-fills-endpoint
        """
    ...
    def get_file_versions(self, file_key):
        ...
        Figma API Endpoint: https://www.figma.com/developers/api#get-file-versions-endpoint
        """
    ...
    def get_comments(self, file_key):
        ...
        Figma API Endpoint: https://www.figma.com/developers/api#get-comments-endpoint
        """
    ...
    def post_comment(self, file_key, message, client_meta=None):
        ...
        Figma API Endpoint: https://www.figma.com/developers/api#post-comments-endpoint
        """
        print(client_meta)
    ...
    def delete_comment(self):
        """
        TODO: Delete a comment from a file

        Figma API Endpoint: https://www.figma.com/developers/api#delete-comments-endpoint
        """
    ...
    def get_team_projects(self, team_id) -> TeamProjects:
        ...
        Figma API Endpoint: https://www.figma.com/developers/api#get-team-projects-endpoint
        """
    ...
    def get_project_files(self, project_id):
        ...
        Figma API Endpoint: https://www.figma.com/developers/api#get-project-files-endpoint
        """
