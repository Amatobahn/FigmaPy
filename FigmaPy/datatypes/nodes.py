...
class Node:
    ...
    def get_file_image_url(self):
        ...
        Use this when you want 1 image, otherwise it's faster to batch your requests
        """
...
class Document(Node):
    ...
    @property
    def pages(self):
        """Get the Pages/Children elements of a Document"""
...
class Group(Frame):
    ...
    Holds properties of Frame except for layoutGrids
    """
...
class RegularPolygon(Vector):
    ...
    def __init__(self, *args, **kwargs):
        """Create a new instance of RegularPolygon"""
        super().__init__(*args, **kwargs)
...
class Rectangle(Vector):
    ...
    Shares properties of Vector plus cornerRadius
    """
...
class Text(Vector):
    ...
    Shares properties of Vector
    Also contains characters, style, characterStyleOverrides, and styleOverrideTable
    """
...
class Component(Frame):
    ...
    Figma Docs: https://www.figma.com/developers/api#library-items

    there is COMPONENT node type, see frame
    Figma Docs: https://www.figma.com/developers/api#node-types
    this is a component node instance in figma, with position scale etc

    there is Component property type
    Figma Docs: https://www.figma.com/developers/api#files-types
    A description of a main component. Helps you identify which component instances are attached to
    this is what file get returns from looking at the attributes
    it resembles a meta file with:
        - keyString
        - nameString
        - descriptionString
...
class ComponentSet(Frame):
    ...
    def __init__(self, *args, **kwargs):
        """Create an instance of ComponentSet"""
        super().__init__(*args, **kwargs)
